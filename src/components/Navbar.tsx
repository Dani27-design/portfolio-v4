...
import { QuantumSyncGimmick as QuantumSync } from "./QuantumSyncGimmick";
import { MobileMenuGimmick as MobileMenu } from "./MobileMenuGimmick";
...
export const Navbar = () => {
  ...
  const navLinks = [
    { name: t('nav.about'), href: '/#about', code: "01" },
    { name: t('nav.stack'), href: '/#skills', code: "02" },
    { name: t('nav.experience'), href: '/#work', code: "03" },
    { name: t('nav.projects'), href: '/#projects', code: "04" },
    { name: t('nav.blog'), href: '/#blog', code: "05" },
  ...
  return (
    <>
      ...
      >
        <QuantumSync isScrolled={isScrolled} />

        <div className="container-custom h-full flex items-center relative z-10">
          {/* Section 1: Brand (Left) */}
          <Link to={localizedPath('/')} className="flex-[1] flex items-center gap-4 group cursor-pointer">
          ...
          {/* Section 2: Core Navigation (Center) - High Symmetry */}
          ...
          <div className="flex-[1] flex justify-end items-center gap-4">
            <div className="hidden md:flex items-center gap-3 pr-4 border-r border-white/5">
              ...
              >
                ...
                <span className="text-[8px] font-mono font-black">{language.toUpperCase()}</span>
              </button>
            </div>
