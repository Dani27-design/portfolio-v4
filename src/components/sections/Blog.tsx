  ...
  return (
    <section id="blog" className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <Reveal>
          <div className="relative flex flex-col items-center md:items-start text-center md:text-left mb-6 md:mb-16">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold tracking-tighter text-text-main">{t('title')}</h2>
            ...
            <Reveal key={blog.id} delay={idx * 0.1} width="100%">
              <a href={`/id/blog/${blog.slug}`} className="block h-full">
                ...
                >
                  ...
                  <p className="text-sm text-text-muted line-clamp-3 leading-relaxed mt-2 flex-grow group-hover:text-text-muted transition-colors">
                    {blog.excerpt[loc]}
                  </p>
