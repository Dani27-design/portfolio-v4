      ...
      <Reveal width="100%">
        <div className="relative p-[1px] bg-gradient-to-r from-cyan-500/50 via-indigo-500/50 to-cyan-500/50 overflow-hidden group">
          ...
          <div className="relative bg-background p-5 sm:p-8 md:p-12 overflow-hidden">
            {/* Scanline Effect */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.1)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-[length:100%_2px,3px_100%] pointer-events-none opacity-20" />
