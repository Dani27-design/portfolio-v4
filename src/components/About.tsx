...
import { NetworkTopologyGimmick } from "./NetworkTopologyGimmick";
          ...
          <Reveal>
            <div className="relative group mx-auto md:mx-0 max-w-fit">
              <div className="w-64 h-64 md:w-80 md:h-80 bg-surface border border-border flex items-center justify-center text-6xl font-bold text-text-muted/10 tracking-tighter relative z-10 select-none overflow-hidden">
                ...
                {/* Internal Decorative Tech Lines */}
          ...
          <Reveal delay={0.2}>
            <div className="space-y-4">
              <h3 className="text-primary uppercase tracking-[0.2em] text-[10px] font-bold">
                <CodeText tag="h3">Structural Engineer</CodeText>
              </h3>
              <h2>
                <CodeText tag="h2" type="html">
                  I architect systems where reliability is the baseline.
                </CodeText>
              </h2>
              <p className="text-lg md:text-xl">
                <CodeText tag="p" type="css">
                  From technical flowcharts and PRDs to backend infrastructure and mobile cores, I own the entire lifecycle. I thrive in the complexity that others avoid, delivering robust, maintainable solutions with a commitment to lifetime maintenance.
                </CodeText>
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.4}>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-12 border-t border-border">
              <div className="space-y-1">
                ...
                <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold">Lifecycle Ownership</div>
              </div>
              <div className="space-y-1">
                <div className="text-3xl font-bold text-text-main">0%</div>
                <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold">Tolerance for Fluff</div>
              </div>
              <div className="space-y-1">
                <div className="text-3xl font-bold text-text-main">TDD</div>
                <div className="text-[10px] uppercase tracking-widest text-text-muted font-bold">Quality Standard</div>
              </div>
            </div>
          </Reveal>
        </div>
