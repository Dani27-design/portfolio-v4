        ...
        >
          ...
          <div className="absolute top-4 left-4 right-4 flex justify-between pointer-events-none z-20">
            <div className="flex flex-col gap-1">
              <span className="font-mono text-[8px] text-white/40 uppercase">Session_Score</span>
            ...
            {score > displayHighScore * 0.8 && score < displayHighScore && displayHighScore > 500 && (
              ...
              >
                <span className="font-mono text-[8px] text-pink-500 font-black uppercase tracking-widest">Near_Record</span>
            ...
            {score > displayHighScore && displayHighScore > 0 && (
              ...
              >
                <span className="font-mono text-[9px] text-yellow-500 font-black uppercase tracking-[0.2em] leading-none translate-y-[0.5px]">New_High_Score</span>
              </motion.div>
            )}

            <div className="flex flex-col items-end gap-1">
              <span className="font-mono text-[8px] text-white/40 uppercase">High_Terminal_Mark</span>
              ...
              >
                <div className="p-8 border border-cyan-500/30 bg-cyan-950/20 rounded-lg flex flex-col items-center gap-6 max-w-sm text-center">
                  <div className="space-y-2">
                    <h3 className="font-mono font-black text-xl text-white uppercase italic">System_Simulation</h3>
                    <p className="text-[10px] font-mono text-text-muted/80 leading-relaxed uppercase tracking-widest">
                       Waiting for defensive deployment...
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="w-full max-w-sm my-auto flex flex-col items-center space-y-3">
                  <div className="text-center">
                    <h2 className="text-4xl font-black text-white italic tracking-tighter uppercase leading-none">CRASHED</h2>
                    <p className="font-mono text-red-500 text-[9px] tracking-[.3em] uppercase font-black mt-1">Simulation_Terminated</p>
                  </div>
                  ...
                  <div className="w-full bg-black/60 border border-white/10 p-4 md:p-6 rounded-lg shadow-2xl backdrop-blur-xl space-y-4">
                     <div className="text-center space-y-0.5">
                        <span className="block font-mono text-[7px] text-white/40 uppercase tracking-widest font-black">Final_Harvest</span>
                     ...
                     <div className="flex flex-col gap-3 pt-4 border-t border-white/10">
                       ...
                       {isNewRecord && !hasSubmittedName && (
                         <div className="flex flex-col gap-2.5">
                           <div className="flex items-center justify-center gap-2 text-yellow-500 bg-yellow-500/5 py-1 rounded-full border border-yellow-500/10">
                             ...
                             <span className="font-mono text-[7px] font-black uppercase tracking-widest">New_Terminal_Mark</span>
                           </div>
                       ...
                       {isNewRecord && hasSubmittedName && (
                         <div className="flex flex-col items-center gap-1 py-1.5 text-cyan-400 bg-cyan-500/5 rounded border border-cyan-500/10">
                            <span className="font-mono text-[8px] font-black uppercase tracking-widest italic">Identity_Secured: {highScoreName}</span>
                         </div>
                       )}
