        ...
        <div className="container-custom h-full flex items-center relative z-10">
          ...
          <Link href="/" className="flex-[1] flex items-center gap-2 xl:gap-4 group cursor-pointer">
            ...
            <div className="hidden sm:flex flex-col justify-center">
              <span className="font-bold tracking-tighter text-base uppercase leading-none group-hover:text-cyan-400 transition-colors whitespace-nowrap">{navbarContent?.brandName ?? 'Daniansyah'}</span>
            </div>
          </Link>
                ...
                const linkContent = (
                  <>
                    ...
                    <div className="flex flex-col">
                      <span className="text-2xl sm:text-3xl font-bold tracking-tighter text-text-main group-hover:text-cyan-400 transition-colors flex items-center gap-4">
                        {link.name}
