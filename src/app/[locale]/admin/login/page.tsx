          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-800 border border-slate-700 rounded pl-10 pr-10 py-2.5 text-sm text-white outline-none focus:border-cyan-500 transition-colors"
                placeholder="••••••••"
                required
              />
              <button
